...
RendererOpenGL::RendererOpenGL() : m_RenderCallsMesh(), m_RenderCallsMeshTransparent(), m_RenderCallsModel()
{
    LUMEDA_PROFILE;
    if (!gladLoadGL())
    {
    ...
    m_ScreenMesh = CreateMesh("Renderer_Quad",
        {
            -1.0f,
            1.0f,
            0.0f,
        ...
        {0, 1, 2, 1, 3, 2},
        {{0, 3, Lumeda::MeshAttribType::FLOAT}, {1, 2, Lumeda::MeshAttribType::FLOAT}});
}
...
Mesh* RendererOpenGL::CreateMesh(const std::string& name,
